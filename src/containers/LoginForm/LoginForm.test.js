...
describe('LoginForm', () => {
  ...
  it('should call handleChange on email input', () => {
    const mockEmailEvent = {
      target: { name: 'email', value: 'hashtagBlessed@mail.com' }
    };
  ...
  it('should call handleChange on password input', () => {
    const mockPasswordEvent = {
      target: { name: 'password', value: '2blessed2bstressed' }
    };
    instance.handleChange = jest.fn();
  ...
  describe('mapDispatchToProps', () => {
    ...
    it('should dispatch loadFavorites when handleSubmit is called', () => {
      const actionToDispatch = loadFavorites([
